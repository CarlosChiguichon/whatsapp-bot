...
def create_ticket(customer_name, customer_phone, customer_email, subject, description):
    """
    ...
    if not subject or not description:
        logging.error("Datos de ticket incompletos: faltan asunto o descripción")
        return {
            "success": False,
