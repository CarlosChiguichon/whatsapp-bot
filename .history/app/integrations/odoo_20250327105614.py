...
def create_ticket(customer_name, customer_phone, customer_email, subject, description, country_id=None):
    """
    ...
    if country_id:
        ...
        logging.info(f"Añadiendo país ID {country_id} al ticket")
